    ...
    <div className="contact-me-card">
      ...
      <div className="contact-links">
        ...
        <a href="https://github.com/" target="_blank" rel="noopener noreferrer" className="contact-link-btn">
          <svg className="contact-link-icon" width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
        ...
        <a href="https://linkedin.com/in/" target="_blank" rel="noopener noreferrer" className="contact-link-btn">
          <svg className="contact-link-icon" width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
